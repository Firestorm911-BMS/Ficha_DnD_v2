...
| 2026-05-24 | BUG-25: tarjeta personalidad | Overflow derecho + literal &lt;div&gt; + reubicación | (1) persistence.js CODEX-10: sanitiza HTML almacenado antes de textContent (strip &lt;div&gt;/&lt;br&gt;, decode entidades). (2) index.html: personalidad movida de col-right a col-left (después de Skills). (3) styles.css: personality-grid cambiado de 2 columnas a 1 columna. |
