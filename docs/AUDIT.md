...
**Fecha de última actualización**: 2026-05-24 (sesión 7 — cierre)
**Rama activa**: `main`
...
| 2026-05-24 | fix | Renombrar "Lore / Historia" → "Backstory" | Etiqueta del `<summary>` en tarjetas de armas (`attacks.js`) y conjuros (`spells.js`), y labels de textareas en los modales de arma y conjuro (`index.html`). commit 3f38120. |
